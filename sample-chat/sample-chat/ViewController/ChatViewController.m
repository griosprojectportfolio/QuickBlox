...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (self.shouldUpdateNavigationStack) {
        ...
        [self.navigationController.viewControllers enumerateObjectsUsingBlock:^(UIViewController* obj, NSUInteger idx, BOOL *stop) {
            if ([obj isKindOfClass:[LoginViewController class]] || [obj isKindOfClass:[DialogsViewController class]]) {
...
- (NSAttributedString *)topLabelAttributedStringForItem:(QBChatMessage *)messageItem {
    ...
    NSString *topLabelText = @"test";//self.opponentUser.fullName != nil ? self.opponentUser.fullName : self.opponentUser.login;
